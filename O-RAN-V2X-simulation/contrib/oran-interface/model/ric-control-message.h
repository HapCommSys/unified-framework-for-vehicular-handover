...
namespace ns3 {
  ...
  {
  public:
    enum ControlMessageRequestIdType { Unknown = 0, TS = 1001, QoS = 1002 };
    RicControlMessage (E2AP_PDU_t *pdu);
    ~RicControlMessage ();

    ControlMessageRequestIdType m_requestType = ControlMessageRequestIdType::Unknown;
