...
#define XAPP_REQ_ID 24
// #define RIC_CONTROL_REQ 24
...
private:
  ...
  void send_ric_control_request(char* payload, std::string gnb_id, long int req_id, long int func_id, const char* control_header);
  void send_ric_control_ts_request(const char* ueImsi, char* targetCellId);
