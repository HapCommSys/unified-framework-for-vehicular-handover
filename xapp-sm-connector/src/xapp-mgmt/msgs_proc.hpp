...
// map<string, string> readPfCuContainer (OCUCP_PF_Container_t *oCU_CP);
// map<string, string> readPfDuContainer (ODU_PF_Container_t *oDU);
// map<string, string> readPfCuContainer (OCUUP_PF_Container_t *oCU_UP);
// map<string, string> ProcessIndicationMessage (E2SM_KPM_IndicationMessage_t *indMsg);
// map<string, string> DecodeIndicationMessage (char *msg, size_t msg_len);
